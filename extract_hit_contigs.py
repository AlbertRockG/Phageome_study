...
parser = argparse.ArgumentParser(
        description =
        """
Command line application to extract the contigs that hit a virus taxon.
It takes a tsv file obtained by using the command ""grep "C" kaiju_output.out""
and the contigs.fasta file obtained from the assembler. It then opens the 
contigs.fasta file and extracts the contig which sequence identifier is 
contained in the tsv file. In the end, it produces a fasta file with
